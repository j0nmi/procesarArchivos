...
namespace DataProcessor
{
    class Program
    {
        ...
        static void Main(string[] args) // Guardamos los argumentos en el array args[]
        {
            WriteLine("Parsing command line options");

            // Primero pide una carpeta como primer argumento (args[0])
            var directoryToWatch = args[0];

            
            if (!Directory.Exists(directoryToWatch)) // Si no existe el fichero
            {
